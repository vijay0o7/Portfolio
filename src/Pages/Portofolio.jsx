...
// Local certificates list (names must match those in the /public/certificates/ folder)
const localCertificates = Array.from({ length: 10 }, (_, i) => ({
...
const techStacks = [
  { icon: "VscodeIconsFileTypePython.svg", language: "Python" },
  { icon: "VscodeIconsFileTypeJava.svg", language: "Java" },
  { icon: "html.svg", language: "HTML" },
  { icon: "css.svg", language: "CSS" },
  { icon: "javascript.svg", language: "JavaScript" },
  { icon: "DeviconFigma.svg", language: "Figma" },
  { icon: "reactjs.svg", language: "ReactJS" },
  { icon: "vite.svg", language: "Vite" },
  { icon: "nodejs.svg", language: "Node JS" },
  { icon: "DeviconAndroidstudio.svg", language: "Android Studio" },
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              bottom: 0,
              background:
                "linear-gradient(180deg, rgba(59, 130, 246, 0.05) 0%, rgba(6, 182, 212, 0.05) 100%)",
            ...
            sx={{
              ...
              "& .MuiTab-root": {
                ...
                "&.Mui-selected": {
                  ...
                  boxShadow: "0 4px 15px -3px rgba(59, 130, 246, 0.25)",
                  "& .lucide": {
                    color: "#06b6d4",
                  },
                },
