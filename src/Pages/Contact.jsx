    ...
    <>
      ...
      >
        <div className="container max-w-3xl">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 transform transition-all duration-500 hover:shadow-[#3b82f6]/10">
            ...
            <form
              action="https://formsubmit.co/Vijaysankarcr@gmail.com"
              method="POST"
